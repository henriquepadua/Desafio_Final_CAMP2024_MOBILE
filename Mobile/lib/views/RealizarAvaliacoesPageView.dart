...
class RealizarAvaliacoesPageViewState
  ...
  Future<void> _sendAvaliacao() async {
    final url = Uri.parse('https://projeto-sementes.onrender.com/avaliacoes/criar');
    final headers = {'Content-Type': 'application/json'};
    final body = json.encode({
      'usuarioAvaliadoId': usuarioAvaliadoId,
      'comunicacao': _selectedCheckboxIndexes[3] != null ? _selectedCheckboxIndexes[3]! + 1 : 0,
      'proatividade': _selectedCheckboxIndexes[2] != null ? _selectedCheckboxIndexes[2]! + 1 : 0,
      'inteligenciaEmocional': _selectedCheckboxIndexes[0] != null ? _selectedCheckboxIndexes[0]! + 1 : 0,
      'flexibilidade': _selectedCheckboxIndexes[1] != null ? _selectedCheckboxIndexes[1]! + 1 : 0,
      'criatividade': _selectedCheckboxIndexes[4] != null ? _selectedCheckboxIndexes[4]! + 1 : 0,
      'observacao': _selectedCheckboxIndexes[5] != null ? _selectedCheckboxIndexes[5]! + 1 : 0,
...
//       nome = prefs.getString('nomePesquisado') ?? 'Nome não encontrado';
//       cargo = prefs.getString('cargoPesquisado') ?? 'Cargo não encontrado';
//       id = prefs.getString('idPesquisado') ?? 'Cargo não encontrado';
//     });
//   }
