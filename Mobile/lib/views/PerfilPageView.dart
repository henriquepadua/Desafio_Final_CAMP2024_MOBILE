...
//   String _cargoAvaliado = '';
//   String _idUsuario =
//       ''; // Adicione uma variável de estado para armazenar o nome
...
//     String cargoUsuario = prefs.getString('cargo') ?? '';
//     String idUsuario = prefs.getString('id') ?? '';
//     String nomeAvaliado = prefs.getString('nomePesquisado') ?? '';
//     String cargoAvaliado = prefs.getString('cargoPesquisado') ?? '';
//     setState(() {
//       _nomeUsuario = nomeUsuario;
//       _cargoUsuario = cargoUsuario;
//       _idUsuario = idUsuario;
//       _cargoAvaliado = cargoAvaliado;
//       _nomeAvaliado = nomeAvaliado; // Atualize o estado com o nome obtido
//     });
//   }
